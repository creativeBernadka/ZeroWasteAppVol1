...
@Database(entities = [Place::class, OpeningHours::class], version = 2, exportSchema = false)
        ...
        fun getDatabase(context: Context, scope: CoroutineScope): PlacesRoomDatabase{
            ...
            synchronized(this){
                val instance = Room.databaseBuilder(
                    ...
                    "Places_database"
                ).addCallback(PlacesDatabaseCallback(scope)).addMigrations(MIGRATION_1_2).build()
                INSTANCE = instance
                return instance
            }
        }
...
//                var place = Place(1, "Miejsce 1",  49.835543, 19.076082, 4.5,
//                    "sklep","123456789", "To jest miejsce 1", website = null)
//                placesDao.insertPlace(place)
//                place = Place(2, "Miejsce 2", 49.83455, 19.077633, 2.75,
//                    "restauracja","123456789", "To jest miejsce 2", website = null)
//                placesDao.insertPlace(place)
//                place = Place(3, "Miejsce 3",  49.834240, 19.079626, 3.25,
